...
<div class="page-banner"><img src="../public/media/services/copywriting.jpg" alt="logistics solutions"></div>
...
<?php if($this->session->userdata('site_lang') == 'arabic'){
  ...
  <div class="wrapper2">
    <h1 class="title2"><?php echo $this->lang->line('log1'); ?></h1>
    <div class="content-part">
      <div class="content-row">
        <div class="fiull-cont">
<p><?php echo $this->lang->line('log2'); ?></p>
<p><?php echo $this->lang->line('log3'); ?></p>
<p><?php echo $this->lang->line('log4'); ?></p>
        </div>
<div class="clr">&nbsp;</div> 
<div class="left fl-left">
<p><?php echo $this->lang->line('log5'); ?></p>
<ul class="bullet">
  <li><?php echo $this->lang->line('log6'); ?></li>
  <li><?php echo $this->lang->line('log7'); ?></li>
  <li><?php echo $this->lang->line('log8'); ?></li>
  <li><?php echo $this->lang->line('log9'); ?></li>
  <li><?php echo $this->lang->line('log10'); ?></li>
  <li><?php echo $this->lang->line('log11'); ?></li>
</ul>
</div>
<!--<div class="right fl-right">
<div class="pattern-img"><img src="../public/media/logistics.jpg" alt="Logistics"></div>
</div>-->
<div class="clr">&nbsp;</div>
<p>&nbsp;</p>
<div class="left fl-left">
<p><?php echo $this->lang->line('log12'); ?></p>
<p><?php echo $this->lang->line('log13'); ?></p>
</div>
<div class="right fl-right">
<p><?php echo $this->lang->line('log14'); ?></p>
</div>
</div>
</div>
</div>
  ...
  <div class="wrapper2">
    ...
    <p><?php echo $this->lang->line('erp28'); ?></p>
      ...
      <div class="form-row">
        ...
        <div class="form-div wid25 input">
          <input class="form-control" placeholder="Designation" type="text" name="<?php echo $this->lang->line('cont12'); ?>" id="designation">
        </div>
        <div class="form-div wid25 input">
          <select class="form-control" name="type" id="type">
              <option value="">Select Service</option>
			 				...
			 				<option value="72" selected="&quot;selected&quot;">Logistics</option>
