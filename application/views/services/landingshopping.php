...
<!--<div class="page-banner"><img src="../public/media/services/shopping.jpg" alt="landing pages for shopping services"></div>-->
<div class="services-derail-page top-cont blue-patten common-padding ">
  <div class="wrapper2">
    <h1 class="title2">Landing Pages for Shopping</h1>
    <div class="content-part">
      <div class="content-row">
        <div class="fiull-cont">
<p>Pinnacle with its gold level of experience offers landing pages for shopping to enterprises who are looking for digital transformation. Pinnacle has always encouraged enterprises towards digital transformation and has even tailor-made programs to cater to the requirements of specific industries.</p>
<p>Our team of experts help enterprises select the most suitable landing pages for shopping which meets their business needs and enable them gain maximum output after the agreement to ensure optimized results and business continuity at minimal cost.</p>
</div>
</div>
</div>
</div>
        ...
        <div class="form-div wid25 input">
          <select class="form-control" name="type" id="type">
              ...
              <option value="68">Postcards</option>
			 				...
			 				<option value="71" selected="&quot;selected&quot;">Landing Pages for Shopping</option>
          </select>
        </div>
      </div>
      <div class="form-row">
