...
<div class="page-banner"><img src="../public/media/services/cctv-m.jpg" alt="Endpoint Protection"></div>
...
<?php if($this->session->userdata('site_lang') == 'arabic'){
  ...
  <div class="wrapper2">
    <h1 class="title2"><?php echo $this->lang->line('cc1'); ?></h1>
    <div class="content-part"> <div class="content-row">
<div class="left fl-left">
<p><?php echo $this->lang->line('cc2'); ?></p>
</div>
<div class="right fl-right">
<p><?php echo $this->lang->line('cc3'); ?></p>
</div>
<div class="clr">&nbsp;</div>
<div class="left fl-left">
<p><?php echo $this->lang->line('cc4'); ?></p>
<p><?php echo $this->lang->line('cc5'); ?></p>
<ul class="bullet">
<li><?php echo $this->lang->line('cc6'); ?></li>
<li><?php echo $this->lang->line('cc7'); ?></li>
<li><?php echo $this->lang->line('cc8'); ?></li>
<li><?php echo $this->lang->line('cc9'); ?></li>
<li><?php echo $this->lang->line('cc10'); ?></li>
<li><?php echo $this->lang->line('cc11'); ?></li>
</ul>
</div>
<!--<div class="right fl-right">
<div class="pattern-img"><img src="../public/media/services/cctv.jpg" alt=""></div>
</div>-->
</div>
</div>
</div>
        ...
        <div class="form-div wid25 input">
          <select class="form-control" name="type" id="type">
              <option value="">Select Service</option>
			 				...
			 				<option value="70" selected="&quot;selected&quot;">CCTV</option>
			 				<option value="71">Contact Centers</option>
          </select>
        </div>
      </div>
      <div class="form-row">
