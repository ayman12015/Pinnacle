...
<div class="page-banner"><img src="../public/media/services/dell.png" alt="Content Creation Services"></div>
<?php if($this->session->userdata('site_lang') == 'arabic'){
  ...
  <div class="wrapper2">
    <h1 class="title2"><?php echo $this->lang->line('cr1'); ?></h1>
    <div class="content-part">
      <div class="content-row">
        <div class="fiull-cont">
<p><?php echo $this->lang->line('cr2'); ?></p>
<p></p>
<p><?php echo $this->lang->line('cr3'); ?></p>
        </div>
      </div>
    </div>
  </div>
        ...
        <div class="form-div wid25 input">
          <select class="form-control" name="type" id="type">
              <option value="">Select Service</option>
			 				...
			 				<option value="66">Copywriting</option>
			 				<option value="72">Media Planning</option>
			 				<option value="70" selected="&quot;selected&quot;">Content Creation</option>
			 				<option value="71">Media Purchasing</option>
			 				<option value="72">Video Production</option>
          </select>
        </div>
      </div>
      <div class="form-row">
